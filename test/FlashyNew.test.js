...
contract('Flash Loan: Aave with Sushiswap & Uniswap V2', () => {
    ...
    it('Flash Loan', async () => {
        ...
        await erc20_transfer(web3, token_name_erc20['WETH'], whales['WETH'], contract.address, funding_amount, 18);
        ...
        await contract.newFlashloan(token_name_erc20['WETH'], amount_In_filter(web3, 100, 18), {from: my_address})
